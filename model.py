...
def get_model(num_classes=11,input_shape=(256,256,3)):
    ...
    out1 = Conv2D((num_classes+5)*3,use_bias=True,kernel_size=(1,1),padding='same')(out1)
    ...
    out2 = Conv2D((num_classes+5)*3,use_bias=True,kernel_size=(1,1),padding='same')(out2)
    ...
    out3 = Conv2D((num_classes+5)*3,use_bias=True,kernel_size=(1,1),padding='same')(out3)
